package com.liuhao.response.exception;
...
public abstract class Assert {
    ...
    public static void notBlank(CharSequence cs, String errorCode, String errMessage) {
        isFalse(isBlank(cs), errorCode, errMessage);
    }

    public static void notBlank(CharSequence cs, String errMessage) {
        isFalse(isBlank(cs), errMessage);
    }

    public static void isBlank(CharSequence cs, String errorCode, String errMessage) {
        isTrue(isBlank(cs), errorCode, errMessage);
    }

    public static void isBlank(CharSequence cs, String errMessage) {
        isTrue(isBlank(cs), errMessage);
    }
